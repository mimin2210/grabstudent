...
$query = "
    SELECT ro.ORDER_FROM, ro.ORDER_TO, ro.ORDER_PAX, ro.ORDER_PRICE, r.PASSENGER_NAME, 
           bf.BUILDING_LOGO AS FROM_LOGO, bt.BUILDING_LOGO AS TO_LOGO
    FROM ride_order ro
    JOIN passenger r ON ro.PASSENGER_ID = r.PASSENGER_ID
    JOIN building bf ON bf.BUILDING_NAME = ro.ORDER_FROM
    JOIN building bt ON bt.BUILDING_NAME = ro.ORDER_TO
    WHERE ro.DRIVER_ID = ? AND ro.ORDER_STATUS = 'DONE'
...
<body>
    ...
    <h1 id="title">DRIVE HISTORY <i class="fa fa-history" aria-hidden="true"></i></h1>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="history">
                    ...
                    <div class="ride-details">
                        ...
                        <p>Passenger: <?php echo htmlspecialchars($row['PASSENGER_NAME']); ?></p>
